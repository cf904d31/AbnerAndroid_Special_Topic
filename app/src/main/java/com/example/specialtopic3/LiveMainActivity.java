...
public class LiveMainActivity extends AppCompatActivity {
    private ListView liveShowList;
    private TextView liveMainTxtTitle;
    ...
    private void intitListView() {
        ...
        liveShowList.setAdapter(adapter);

        liveShowList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Log.d("Abner","i = " + id);
                Toast.makeText(LiveMainActivity.this,"title=" + linkedList.get(position).get("title"),Toast.LENGTH_SHORT).show();
        ...
        liveShowList.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
            @Override
            public boolean onItemLongClick(AdapterView<?> parent, View view, int position, long id) {
                Log.d("Abner","i = " + position + "->Long");
                Toast.makeText(LiveMainActivity.this,"Long OK",Toast.LENGTH_SHORT).show();
                return true;
            }
        });
    }
